...
import { Moon, Sun, Bell, Search, Menu, Building2, Sparkles, User, LogOut, Settings, ChevronDown, TrendingUp, Users, Briefcase } from "lucide-react";
        ...
        <div className="relative">
          ...
          {showDropdown && (
            <div className={`absolute right-0 mt-3 w-56 rounded-2xl shadow-2xl border z-50 overflow-hidden animate-scaleIn ${isDarkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"}`}>
              ...
              <div className="py-2">
                <button onClick={() => navigate("/cdc/settings")} className={`w-full flex items-center gap-3 px-4 py-2.5 ${isDarkMode ? "hover:bg-gray-700/50 text-gray-300" : "hover:bg-gray-50 text-gray-700"}`}>
                  <Settings size={18} />
