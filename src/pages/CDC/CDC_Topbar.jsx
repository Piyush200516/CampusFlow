  ...
  return (
    <div className={`w-full flex justify-between items-center px-4 md:px-6 py-3 shadow-lg transition-all duration-300 backdrop-blur-sm ${
      ...
      <div className="flex items-center gap-3">
        ...
        {/* Logo */}
        <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-green-500 via-teal-500 to-emerald-600 rounded-xl flex items-center justify-center shadow-lg shadow-green-500/25">
