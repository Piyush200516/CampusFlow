    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-blue-800 to-indigo-900 p-4">
      ...
      <div className="relative bg-white/10 backdrop-blur-lg rounded-3xl shadow-2xl w-full max-w-md p-8 border border-white/20">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-blue-200 mt-2">Access your campus portal</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleLogin}>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 rounded-xl font-semibold text-white transition-all duration-300 hover:scale-[1.02] hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
          >
        ...
        <div className="mt-8 space-y-3">
          <p className="text-center text-blue-200">
            ...
            <Link to="/signup" className="text-white font-medium hover:text-blue-200 transition-colors">
              Register Now
            </Link>
          </p>
          <Link
            to="/login"
            className="block text-center text-blue-300 hover:text-white transition-colors"
          >
