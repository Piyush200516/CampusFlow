...
import { DollarSign, CreditCard, Users, FileText, CheckCircle, XCircle, Clock, TrendingUp, ArrowRight } from "lucide-react";
    ...
    <div className={`p-6 min-h-screen transition-colors duration-300 ${isDarkMode ? "bg-gray-900" : "bg-gray-50"}`}>
      ...
      <div className="mb-6">
        ...
        <p className={`transition-colors duration-300 ${isDarkMode ? "text-gray-400" : "text-gray-500"}`}>
          Manage student fees and track transactions
        </p>
      </div>
      ...
      <div className={`border rounded-xl p-6 shadow-sm mb-8 transition-colors duration-300 ${
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button 
            onClick={() => navigate("/fee/tc-approval")}
            className="flex items-center gap-2 bg-orange-600 text-white px-5 py-2.5 rounded-lg hover:bg-orange-700 transition-colors duration-300 font-medium"
          >
            <FileText size={18} />
            TC Approval
          </button>
            ...
            <tbody>
              <tr className={`border-b hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-300 ${
                ...
                <td className="py-3 px-4">
                  <span className="flex items-center gap-1 bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm font-medium w-fit">
              ...
              <tr className={`border-b hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-300 ${
                ...
                <td className="py-3 px-4">
                  <span className="flex items-center gap-1 bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm font-medium w-fit">
              ...
              <tr className={`hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors duration-300 ${
                ...
                <td className="py-3 px-4">
                  <span className="flex items-center gap-1 bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-sm font-medium w-fit">
